            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <div class="d-flex text-end offset-9 my-2">
                    <input type="text" class="form-control col-10 " v-model="searchKey" @keyup.enter="search()">
   
                    <i class="fa-solid fa-magnifying-glass mt-2 ml-3 "  style="font-size: 25px;"  @click="search()"></i>
                          ...
                          {{ post.title }}
                            ...
                            <div class="single-what-news mb-100">
                              <div class="what-img">
                                ...
                                <!-- <img src="http://localhost:8000/postImage/6614df678b01a_website-shopping-cart-page.png"  alt=""> -->
                              </div>
                              <div class="what-cap">
                                <span class="color1"> {{ post.title }}</span>
                                <h4>
                                  <a href="details.html"
                                    >Welcome To The Code lab Model Winner Contest</a
                                  >
                                </h4>
                              </div>
                            </div>
